...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lbConnectionStatus.setAutoFillBackground(False)
        ...
        self.cbProjects = QtWidgets.QComboBox(Dialog)
        self.cbProjects.setObjectName("cbProjects")
        self.verticalLayout_2.addWidget(self.cbProjects)
        ...
        self.leUserSelect = QtWidgets.QLineEdit(Dialog)
        self.leUserSelect.setObjectName("leUserSelect")
        self.verticalLayout_3.addWidget(self.leUserSelect)
        self.lvUsers = QtWidgets.QListView(Dialog)
        self.lvUsers.setAlternatingRowColors(True)
        self.lvUsers.setSelectionMode(QtWidgets.QAbstractItemView.MultiSelection)
        self.lvUsers.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectItems)
        ...
        self.btnImportExcel = QtWidgets.QPushButton(Dialog)
        self.btnImportExcel.setObjectName("btnImportExcel")
        self.verticalLayout_7.addWidget(self.btnImportExcel)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btnImportExcel.setText(_translate("Dialog", "Import Excel"))
